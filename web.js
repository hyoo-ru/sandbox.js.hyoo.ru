...
;
	($.$hyoo_js_sandbox) = class $hyoo_js_sandbox extends ($.$mol_page) {
		Lights(){
		...
		Source(){
			...
			(obj.uri) = () => ("https://github.com/hyoo-ru/sandbox.js.hyoo.ru");
			return obj;
		}
		theme(){
		...
		intro(){
			return (this.$.$mol_locale.text("$hyoo_js_sandbox_intro"));
		}
		Intro(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.intro()));
		...
		Code(){
			...
			(obj.hint) = () => ("return 42");
			(obj.value) = (next) => ((this.script(next)));
			return obj;
		}
		run_hint(){
			return (this.$.$mol_locale.text("$hyoo_js_sandbox_run_hint"));
		}
		Run_icon(){
		...
		title(){
			return (this.$.$mol_locale.text("$hyoo_js_sandbox_title"));
		}
		tools(){
		...
		Snippet(id){
			const obj = new this.$.$hyoo_js_sandbox_snippet();
	...
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Lights"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Source"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Theme"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "run"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Hotkey"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Intro"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "script"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Code"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Run_icon"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Run"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Input"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "result"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Result"));
	($mol_mem(($.$hyoo_js_sandbox.prototype), "Snippets"));
	($mol_mem_key(($.$hyoo_js_sandbox.prototype), "Snippet"));
	($.$hyoo_js_sandbox_snippet) = class $hyoo_js_sandbox_snippet extends ($.$mol_link) {
		code(){
			return "";
		}
		theme_content(){
		...
		Text(){
			const obj = new this.$.$mol_text();
			(obj.attr) = () => ({"mol_theme": (this.theme_content())});
			(obj.text) = () => ((this.text()));
			return obj;
		}
		arg(){
	...
	($mol_mem(($.$hyoo_js_sandbox_snippet.prototype), "Text"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_js_sandbox.prototype, "script_to_execute", null);
        __decorate([
            $mol_mem
        ], $hyoo_js_sandbox.prototype, "Sandbox", null);
        __decorate([
            $mol_mem
        ], $hyoo_js_sandbox.prototype, "func", null);
        __decorate([
            $mol_mem
        ], $hyoo_js_sandbox.prototype, "result", null);
        $$.$hyoo_js_sandbox = $hyoo_js_sandbox;
        ...
        $$.$hyoo_js_sandbox_snippet = $hyoo_js_sandbox_snippet;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
