...
declare namespace $ {
	...
	>
	type $mol_hotkey__mod_ctrl_hyoo_js_sandbox_2 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_hotkey['mod_ctrl'] >
	>
	type $mol_hotkey__key_hyoo_js_sandbox_3 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_hotkey['key'] >
	>
	type $mol_text__text_hyoo_js_sandbox_4 = $mol_type_enforce<
		ReturnType< $hyoo_js_sandbox['intro'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_textarea__hint_hyoo_js_sandbox_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_hyoo_js_sandbox_6 = $mol_type_enforce<
		ReturnType< $hyoo_js_sandbox['script'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_button_major__hint_hyoo_js_sandbox_7 = $mol_type_enforce<
		ReturnType< $hyoo_js_sandbox['run_hint'] >
		,
		ReturnType< $mol_button_major['hint'] >
	>
	type $mol_button_major__click_hyoo_js_sandbox_8 = $mol_type_enforce<
		ReturnType< $hyoo_js_sandbox['run'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub_hyoo_js_sandbox_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_bar__sub_hyoo_js_sandbox_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_bar['sub'] >
	>
	type $mol_view__sub_hyoo_js_sandbox_11 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows_hyoo_js_sandbox_12 = $mol_type_enforce<
		ReturnType< $hyoo_js_sandbox['snippets'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $hyoo_js_sandbox_snippet__code_hyoo_js_sandbox_13 = $mol_type_enforce<
	...
	type $mol_text__attr_hyoo_js_sandbox_snippet_1 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_text['attr'] >
	>
	type $mol_text__text_hyoo_js_sandbox_snippet_2 = $mol_type_enforce<
