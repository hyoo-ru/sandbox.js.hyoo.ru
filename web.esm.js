...
(function ($) {
    class $hyoo_js_sandbox extends $.$mol_page {
        ...
        body() {
            return [this.Intro(), this.Input(), this.Result(), this.Snippets()];
        }
        Intro() {
            return ((obj) => {
                obj.text = () => this.intro();
        ...
        Snippet(id) {
            return ((obj) => {
                ...
                return obj;
            })(new this.$.$hyoo_js_sandbox_snippet());
        }
        snippet_code(id) {
            return "";
        }
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Lights", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Source", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Theme", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Hotkey", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "run", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Intro", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Input", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Code", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "script", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Run", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Run_icon", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox.prototype, "Snippets", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_js_sandbox.prototype, "Snippet", null);
    $.$hyoo_js_sandbox = $hyoo_js_sandbox;
})($ || ($ = {}));
(function ($) {
    class $hyoo_js_sandbox_snippet extends $.$mol_link {
        arg() {
            return ({
                "script": this.code(),
            });
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_js_sandbox_snippet.prototype, "Text", null);
    $.$hyoo_js_sandbox_snippet = $hyoo_js_sandbox_snippet;
})($ || ($ = {}));
//sandbox.view.tree.js.map
;
"use strict";
var $;
(function ($) {
